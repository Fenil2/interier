...
export default function DifferenceFooter() {
  return (
    <footer className="bg-[#f6f3ee] text-[#131b2e]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 py-16 max-w-[1440px] mx-auto leading-relaxed">
        {/* Brand */}
        <div className="md:col-span-1">
          ...
          <p className="text-on-secondary-fixed-variant text-sm mb-6">
            Architecture is the physical manifestation of soul and precision.
            Built with integrity since 2008.
          </p>
