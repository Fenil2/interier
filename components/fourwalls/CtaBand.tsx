...
export default function CtaBand() {
  return (
    <section className="bg-[#c8a856] py-10 md:py-20">
      <Container>
        <div className="flex flex-col items-center gap-8 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left sm:gap-12">
          <MotionReveal>
            <div>
              <h2 className="font-(family-name:--font-outfit) text-[clamp(2rem,3.5vw,3rem)] font-bold leading-[1.18] text-[#1a2e20]">
                Let&apos;s Create Something <em className="italic">Exceptional</em>
              </h2>
              <p className="mt-2 text-[0.95rem] font-light text-[#1a2e20]/55">
