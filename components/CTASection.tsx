...
export default function CTASection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#0d1420] py-20 text-white md:py-28">
      {/* Parallax background */}
          ...
          <div className="border border-white/15 bg-[#f6f3ee] p-5 text-[#131b2e] shadow-2xl md:p-6">
            <div className="border-b border-[#131b2e]/10 pb-5">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#3c475a]">
                A senior-led team for residential, commercial, and landmark interiors.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-px bg-[#131b2e]/10">
              {stats.map(({ value, label }, i) => (
                ...
                >
                  <p
                    className="text-3xl font-bold text-[#131b2e]"
                    style={{ fontFamily: "var(--font-noto-serif), serif" }}
                  >
                    {value}
                  </p>
